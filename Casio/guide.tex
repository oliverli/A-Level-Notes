...
Once a graph is plotted, you can sketch additional graphs on top of the already plotted graph. This includes sketching the \addtoindex{inverse} of a function, \addtoindex{tangent} and \addtoindex{normal} to a point on the curve.
