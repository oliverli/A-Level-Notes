...
Casio added support for vectors beginning with firmware version \code{02.04.5301}, on top of support for matrices. Matrices will be covered in Chapter \ref{linalge} (Linear Algebra).\footnote{While vectors are also covered in the Linear Algebra syllabus, this chapter will focus more on what is needed to tackle the H2 syllabus.}
...
\chapter{Linear Algebra} \label{linalge}
