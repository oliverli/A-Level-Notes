...
\caution{Vector capabilities will be disabled in the new \textit{Exam Mode} that ships with the Ver. \code{2.09} update\footnote{We will not be covering this as we are covering Ver. \code{2.04.5301}, the latest SEAB approved firmware version.}.}
