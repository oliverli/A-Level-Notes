	...
	\section{Forces}
		\begin{center}
			...
			\begin{tabular}{@{} l l p{8.5cm} @{}}
				...
				Upthrust & The \textbf{\textit{net force exerted by a fluid}} on a body submerged in the fluid. \\
				Principle of Floatation &  & For an object floating in equillibrium in a fluid $mg=U=\rho V_{dis} g$ \\
				\bottomrule
			\end{tabular}
		\end{center}
