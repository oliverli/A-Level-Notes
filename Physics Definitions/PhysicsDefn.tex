...
\begin{document}
	...
	\begin{center}
		...
		\begin{tabular}{@{} l l p{9cm} @{}}
			\toprule
			Displacement & $\textbf{s}$ & Displacement of an object from a reference point is the linear distance and direction of the object from the point. \\
		...
		\subsection{Momentum}
			\begin{center}
				...
				\begin{tabular}{@{} p{2.7cm} l p{6.8cm} @{}}
					\toprule
					Linear \newline Momentum & $\textbf{p}=m\textbf{v}$ & The product of an object's mass and its velocity. \\
		...
		\subsection{Photoelectric Effect}
			\begin{center}
				...
				\begin{tabular}{@{} l p{10.3cm} @{}}
					\toprule
					$hf=\Phi+KE_{max}$ & The \textit{Photoelectric Effect} is the liberation of electrons from a cool metal surface when EM radiation of sufficiently high frequency is incident on it. This provides evidence of the particulate nature of EM radiation. $$KE_{max}=\frac{1}{2}mv_{max}^2=eV_{s}$$ \vspace*{-\baselineskip}\\
	...
	\begin{center}
		...
		\begin{tabular}{@{} l p{10cm} @{}}
			...
			Mass Defect & The difference between the mass of a nuclide and its constituent nucleons, representing binding energy. \\
			...
			Decay Constant & \textbf{Probability per unit time} that a nucleus will decay. SI unit is \si{\per\second}. $$\lambda = \frac{A}{N} = \frac{\text{disintegrations}}{\text{total}}$$ \vspace*{-\baselineskip}\\
