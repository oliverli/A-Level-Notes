		...
		\subsection{Line Spectra}
			...
			\begin{center}
				...
				\begin{tabular}{@{} l p{10.9cm} @{}}
					\toprule
					Emission Spectrum & Bright coloured lines on dark background. \par This is due to the photons produced when de-excitation takes place from a higer to a lower energy state. \\
